...
import 'package:netflix_clone/feature/Profile/Edit%20Profile/edit_profile_mixin.dart';
      ...
      onTap: () {
        widget.isEditing
            ...
            : navigatoToWidget(
                context,
                TabBarScreen(
                  profileImage: widget.viewModel.profiles[widget.index]['photoURL'] ?? 'https://picsum.photos/200',
    ...
    return Stack(
      ...
      children: [
        AvatarCard(
          ...
          photoURL: widget.viewModel.profiles[widget.index]['photoURL'] ?? 'https://picsum.photos/200',
        ),
        widget.isEditing
            ? const Icon(
                Icons.edit,
