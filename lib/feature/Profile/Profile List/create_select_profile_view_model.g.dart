...
mixin _$CreateSelectProfileViewModel
  ...
  late final _$isEditingAtom = Atom(
      name: '_CreateSelectProfileViewModelBase.isEditing', context: context);
  ...
  void setIsEditing() {
    final _$actionInfo = _$_CreateSelectProfileViewModelBaseActionController
        .startAction(name: '_CreateSelectProfileViewModelBase.setIsEditing');
    try {
  ...
  Future<void> updateProfile(int index, String username, String? photoURL) {
    final _$actionInfo = _$_CreateSelectProfileViewModelBaseActionController
        .startAction(name: '_CreateSelectProfileViewModelBase.updateProfile');
    try {
      return super.updateProfile(index, username, photoURL);
    } finally {
      _$_CreateSelectProfileViewModelBaseActionController
          .endAction(_$actionInfo);
    }
